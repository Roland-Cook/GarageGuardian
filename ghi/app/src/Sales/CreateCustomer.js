    ...
    return (
        ...
        <div className="offset-3 col-6">
            ...
            <h1 className="card-title">Add a customer</h1>
                ...
                <div className="col">
                    <div className="form-floating mb-3">
                    <input required onChange={handlePhoneNumChange} value={phoneNum} placeholder="XXX-XXX-XXXX" type="text" id="phone_number" name="phone_number" className="form-control" />
